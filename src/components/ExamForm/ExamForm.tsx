...
export default function ExamForm({ exams, tasks, onAdd, onUpdate, onDelete, milestones, onAddMilestones }: ExtendedExamFormProps) {
  ...
  const [milestoneMessage, setMilestoneMessage] = useState<{examId: string, type: 'error' | 'success', text: string} | null>(null)
  ...
  function handleGenerateMilestones(exam: ExamInfo) {
    ...
    if (res.success === false) {
      ...
      setMilestoneMessage({ examId: exam.id, type: 'success', text: "Tạo mốc ôn tập thành công!" })
    }
