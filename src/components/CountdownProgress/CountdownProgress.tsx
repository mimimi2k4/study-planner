 ...
 */
export default function CountdownProgress({ exam, progress }: CountdownProgressProps) {
    ...
    if (!exam) {
        return (
            <Link to="/exams" className="btn btn-primary" style={{ textDecoration: "none" }}>
                Thêm lịch thi ngay
            </Link>
        );
    }
    ...
    return (
        <div className="flex items-center gap-4 p-4 bg-emerald-50/50 rounded-lg border border-emerald-100">
            ...
            <div className="flex flex-col">
                ...
                {total > 0 && (
                    <div className="mt-2 w-48 bg-slate-200/50 rounded-full h-2 overflow-hidden">
