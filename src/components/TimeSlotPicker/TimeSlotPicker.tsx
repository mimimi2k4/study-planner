                    ...
                    {Object.entries(ZONE).map(([key, z]) => (
                        <span key={key} className="flex items-center gap-1.5">
                            <span
                                ...
                                style={{ background: z.bg, border: `2px solid ${z.legendBorder}` }}
                            />
                            {z.name}
                        </span>
                    ))}
            ...
            {/* ── Grid ── */}
                ...
                <div className="overflow-x-auto">
                    <div style={{ minWidth: 580 }}>
                        ...
                        >
                            <div className="py-4 text-center text-xs font-bold text-slate-400 uppercase tracking-wider">
                                Giờ
                            </div>
                            {DAYS.map((d, i) => (
                        ...
                        <div className="select-none">
                            {Array.from({ length: SLOTS }, (_, row) => {
                                ...
                                return (
                                    ...
                                    >
                                        <div
                                            className="flex items-center justify-end pr-3 border-r border-slate-100"
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <p
                                            ...
                                            style={{ color: z.labelColor, opacity: 0.6 }}
                                        >
                                            {dur} phút
                                        </p>
                                    </div>
